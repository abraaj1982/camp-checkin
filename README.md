...
**1. تبويب باسم "Students":**
| A: ID | B: Name | C: Group (اختياري) | D: Size | E: Given At | F: Given By |
|-------|---------|----------------------|---------|--------------|---------------|
...
- **D (Size)** هو المقاس المسجل مسبقاً. أعمدة E و F اتركها فارغة، النظام يملؤها تلقائياً وقت التسليم.
